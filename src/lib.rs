...
// // enum SchemaOrBuilder{
// //     Schema(Schema),
// //     Builder(Option<SchemaBuilder>),
// // }

// // impl SchemaOrBuilder {
// //     fn is_empty(&self){
// //         match self {
// //             SchemaOrBuilder::Builder(None) => true,
// //             _ => false,
// //         }
// //     }
// // }
...
// // impl Toto {
// //     fn new(serialized_directory: &str)-> Self {
// //         Self{
// //             schema: SchemaOrBuilder::Builder(Some(Schema::builder())),
// //         }
// //     }

// //     fn add_field(&mut self){
// //         match self.schema {
// //             SchemaOrBuilder::Builder(schema_builder) => {
// //                 schema_builder.as_ref().expect("The schema builder should never be None").add_text_field("title", TEXT);
// //             }
// //             SchemaOrBuilder::Schema(_) => {
// //                 panic!("Can't add fields to a schema after finalization")
// //             }
// //         }
// //     }

// //     fn add_stored_field(&mut self){
// //          match self.schema {
// //             SchemaOrBuilder::Builder(schema_builder) => {
// //                 schema_builder.as_ref().expect("The schema builder should never be None").add_text_field("title", TEXT | STORED);
// //             }
// //             SchemaOrBuilder::Schema(_) => {
// //                 panic!("Can't add fields to a schema after finalization")
// //             }
...
// //         let schema = if let SchemaOrBuilder::Builder(schema_builder) = self.schema {
// //             let schema = schema_builder.take().expect("The schema builder should never be None").build();
// //         }else{
// //             panic!("Can't finalize a schema twice");
// //         };
// //         let empty_builder_shell = mem::replace(&mut self.schema, SchemaOrBuilder::Schema(schema));
// //         assert!(empty_builder_shell.is_empty())
// //     }

// //     fn search(&self, query: &str, fields: &[&str]) -> String {
